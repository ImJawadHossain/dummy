 ...
 *
 * Storage:
 *   Records map ............ localStorage["calculus_formula_srs_v1"]
...
(function () {
  ...
  function migrateFromKnownWords() {
    const old = JSON.parse(localStorage.getItem("calculus_formula_knownWords") || "[]");
