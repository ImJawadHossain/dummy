 ...
 * - Respects defaults for Reverse & Show Example
...
document.addEventListener("DOMContentLoaded", () => {
  // DEFAULT: Show Example based on settings
...
cardDiv.innerHTML = `
  <div class="card-inner">
    <div class="card-front">
      <button class="known-icon" onclick="event.stopPropagation(); markGood()">✅</button>
...
function finishSession() {
  try {
    localStorage.setItem(
      "calculus_formula_srs_session_complete",
      JSON.stringify({ ts: Date.now(), reviewed: reviewedThisSession })
    );
  } catch {}
  window.location.href = "/calculus_formula";
}
